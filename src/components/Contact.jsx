          ...
          <div className="lg:w-1/2 w-full flex flex-col justify-center items-center">
            ...
            <div className="flex flex-col justify-center items-center gap-4">
              ...
              <div className="flex gap-6">
                <a className="text-primary lg:scale-125 hover:-translate-y-2 hover:rotate-3" href="https://github.com/guillezdev" aria-label="Enlace a guithub"><FaGithub size={40} /></a>
                <a className="text-primary lg:scale-125 hover:-translate-y-2 hover:rotate-3" href="https://www.linkedin.com/in/guillezdev/" aria-label="Enlace a Linkedin"><FaLinkedin size={40} /></a>
              </div>
            </div>
